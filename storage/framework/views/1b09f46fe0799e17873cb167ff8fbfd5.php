...
<section class="py-8 bg-gray-50 border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-center space-x-4">
            <span class="text-lg font-medium <?php echo e($billing === 'monthly' ? 'text-gray-900' : 'text-gray-500'); ?>" id="monthly-label">Monthly</span>
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" id="billing-toggle" class="sr-only" <?php echo e($billing === 'annual' ? 'checked' : ''); ?>>
            ...
            <span class="text-lg font-medium <?php echo e($billing === 'annual' ? 'text-gray-900' : 'text-gray-500'); ?>" id="annual-label">
                Annual 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pricing-card bg-white rounded-lg shadow-lg p-8 <?php echo e($plan['featured'] ? 'ring-2 ring-blue-500 transform scale-105' : ''); ?>">
                    ...
                    <div class="mb-8">
                        <?php if($plan['price_monthly'] === 'Custom'): ?>
                            <span class="text-4xl font-bold text-gray-900">Custom</span>
                        <?php else: ?>
                            <span class="text-4xl font-bold text-gray-900">
                                $<?php echo e($billing === 'annual' ? $plan['price_annual'] : $plan['price_monthly']); ?>

                            </span>
                            <span class="text-gray-600 text-lg">
                                /<?php echo e($billing === 'annual' ? 'year' : 'month'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.marketing.cta-button','data' => ['href' => '#','text' => 'Contact Sales','variant' => 'outline','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','text' => 'Contact Sales','variant' => 'outline','class' => 'w-full']); ?>
...
<?php endif; ?>
                    <?php else: ?>
                        <?php if (isset($component)) { $__componentOriginal1aa422193007bd9e0df279000994c6f0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1aa422193007bd9e0df279000994c6f0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.marketing.cta-button','data' => ['href' => ''.e(route('register', ['plan' => strtolower($plan['name'])])).'','text' => 'Start Free Trial','variant' => 'primary','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('marketing.cta-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('register', ['plan' => strtolower($plan['name'])])).'','text' => 'Start Free Trial','variant' => 'primary','class' => 'w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1aa422193007bd9e0df279000994c6f0)): ?>
<?php $attributes = $__attributesOriginal1aa422193007bd9e0df279000994c6f0; ?>
...
<section class="py-20 bg-blue-600 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <?php if (isset($component)) { $__componentOriginal1aa422193007bd9e0df279000994c6f0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1aa422193007bd9e0df279000994c6f0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.marketing.cta-button','data' => ['href' => ''.e(route('pricing')).'','text' => 'Start Your 14-Day Free Trial','variant' => 'secondary','size' => 'xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('marketing.cta-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pricing')).'','text' => 'Start Your 14-Day Free Trial','variant' => 'secondary','size' => 'xl']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1aa422193007bd9e0df279000994c6f0)): ?>
<?php $attributes = $__attributesOriginal1aa422193007bd9e0df279000994c6f0; ?>
...
<?php echo $__env->make('layouts.marketing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/peter/github/alpha/resources/views/marketing/pricing.blade.php ENDPATH**/ ?>